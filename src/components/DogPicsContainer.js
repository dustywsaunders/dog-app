...
export default class DogPicsContainer extends React.Component {
  ...
  getImages () {
    request(`https://dog.ceo/api/breed/${Object.keys(this.state.breeds)[2]}/images`)
...
// this.setState({ img: images })
  ...
  render() {
    ...
    <h2>This is {Object.keys(this.state.breeds)[2]}</h2>
    {/* <img src='https://images.dog.ceo/breeds/airedale/n02096051_1111.jpg' alt='img'></img> */}
    <img src={this.state.img[Math.floor(Math.random()*100)]} alt='img'></img>
